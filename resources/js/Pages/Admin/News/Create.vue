                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="page-subtitle text-muted">
                            Buat dan publikasikan berita terbaru Anda
                        </p>
                    </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="form-section">
                            <div class="section-header">
                                ...
                                <p class="section-subtitle">Isi detail utama berita Anda</p>
                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-2">
                                            <button type="button" 
                                                ...
                                                <i :class="gettingLocation ? 'fa fa-spinner fa-spin' : 'fa fa-map-marker'" class="me-1"></i>
                                                {{ gettingLocation ? 'Mendapatkan Lokasi...' : 'Gunakan Lokasi Saat Ini' }}
                                            </button>
                                            <small class="form-text text-muted d-block">
                                                Klik untuk mengisi koordinat otomatis dari lokasi Anda saat ini
                                            </small>
                                        </div>
...
onMounted(() => {
    ...
    // Set default published_at for published status
